---FIND and replace: FromzaAdmin with your required DatabaseName acc. to Branch---



/****** Object:  Table [dbo].[Fromza_SQLAuditLog]    Script Date: 5/11/2018 8:20:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
DROP TABLE IF EXISTS [dbo].[Fromza_SQLAuditLog];
CREATE TABLE [dbo].[Fromza_SQLAuditLog](
...
SET QUOTED_IDENTIFIER ON
GO
DROP TABLE IF EXISTS [dbo].[SysAdmin_DBLog];
...
SET QUOTED_IDENTIFIER ON
GO
DROP TABLE IF EXISTS [dbo].[SysAdmin_Parameters];
...
GO
INSERT [dbo].[SysAdmin_Parameters] ([ParameterId], [ParameterGroupName], [ParameterName], [ParameterValue], [ValueDataType], [Description], [CreatedOn]) VALUES (5, N'Admin', N'LiveDBName', N'Fromza_EMR_LIVE', N'string', N'This for store current Live DB Name for taking backup not AdminDB', CAST(N'2017-09-13T23:14:46.107' AS DateTime))
GO
INSERT [dbo].[SysAdmin_Parameters] ([ParameterId], [ParameterGroupName], [ParameterName], [ParameterValue], [ValueDataType], [Description], [CreatedOn]) VALUES (6, N'Common', N'SQLAuditFilePath', N'C:\\FromzaHealthInc_PvtLtd_Files\R2V1_Dev\Data\DbAudit\', N'string', N'Location path for save sql audit file', CAST(N'2017-12-15T17:49:43.280' AS DateTime))
GO
...
GO
ALTER TABLE [dbo].[Fromza_SQLAuditLog] ADD  DEFAULT (getdate()) FOR [AuditDate]
GO
/****** Object:  StoredProcedure [dbo].[SP_Fromza_SQLAudit]    Script Date: 5/11/2018 8:20:32 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
CREATE OR ALTER PROCEDURE [dbo].[SP_Fromza_SQLAudit]
...
EXECUTE  (@sqlQuery)
END-----end of SP: SP_Fromza_SQLAudit -- 
GO
...
GO
CREATE OR ALTER PROCEDURE [dbo].[SP_SysADM_Backup_Database] 
(
@CreatedBy int=null,
...
GO
CREATE OR ALTER PROCEDURE [dbo].[SP_SysADM_Delete_DatabaseBackup] 
AS
/*
...
GO
CREATE OR ALTER PROCEDURE [dbo].[SP_SysADM_Insert_DBLog] 
(
@FileName varchar(50)=null,
@FolderPath varchar(100)=null,
@DatabaseName varchar(50)=null,
...
/****** Object:  Table [dbo].[FromzaAudit]    Script Date: 23-01-2019 14:59:49 ******/

DROP TABLE IF EXISTS [dbo].[FromzaAudit];
CREATE TABLE [dbo].[FromzaAudit](
	[AuditId] [bigint] IDENTITY(1,1) NOT NULL,
	[InsertedDate] [datetime] NOT NULL,
	[LastUpdatedDate] [datetime] NULL,
	[Data] [nvarchar](max) NOT NULL,
 CONSTRAINT [PK_FromzaAudit] PRIMARY KEY CLUSTERED 
(
	[AuditId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
ALTER TABLE [dbo].[FromzaAudit] ADD  DEFAULT (getdate()) FOR [InsertedDate]
GO

/****** Object:  UserDefinedFunction [dbo].[Fn_Fromza_Audit]    Script Date: 23-01-2019 14:59:49 ******/


CREATE FUNCTION [dbo].[Fn_Fromza_Audit]()
...
/****** Object:  StoredProcedure [dbo].[SP_Fromza_Audit]    Script Date: 28-01-2019 17:16:46 ******/

 
GO
CREATE OR ALTER PROCEDURE [dbo].[SP_Fromza_Audit]
  @FromDate datetime=null ,
		@ToDate datetime=null,
...
begin
SELECT *
FROM [dbo].[Fn_Fromza_Audit]() tbl1
    INNER JOIN [dbo].[RBAC_User] tbl2
...
/****** Object:  StoredProcedure [dbo].[SP_Fromza_Audit_List]    Script Date: 28-01-2019 17:52:57 ******/


GO
CREATE OR ALTER PROCEDURE [dbo].[SP_Fromza_Audit_List]
AS
...
begin
select  distinct Table_Name From dbo.[Fn_Fromza_Audit]() 
end
GO


--Anish: LogIn/LogOut Info added to custom table--
DROP TABLE IF EXISTS [dbo].[FromzaLogInInformation];
CREATE TABLE [dbo].[FromzaLogInInformation](
...
DROP TABLE IF EXISTS [dbo].[Fromza_CookieAuthInfo];
CREATE TABLE [dbo].[Fromza_CookieAuthInfo](
...
/****** Object:  StoredProcedure [dbo].[SP_Fromza_Audit]    Script Date: 11/10/2019 12:36:25 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
/*
EXEC SP_Fromza_Audit '2019-10-10','2019-12-12','BIL_TXN_BillingTransaction','admin'
...
SET QUOTED_IDENTIFIER ON
GO
DROP TABLE IF EXISTS [dbo].[tbl_AuditTableDisplayName];
...
--EXEC (@DynamicQuery) 
	...
	-- Select Query
	SELECT * FROM Fn_Fromza_Audit() tbl1
	WHERE (  
